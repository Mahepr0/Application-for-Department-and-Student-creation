...
body {
  ...
  background: url(https://img.freepik.com/free-vector/college-building-educational-institution-banner_1441-3616.jpg?w=2000);
}
h1
{
	font-size: 30px;
...
<body>
<h1>Overview of the departments</h1>
<table border="1">
<tr>
<th>Department ID</th>
